...
//const CLIENT_URL = `https://mern-api-pilar.onrender.com`;
  ...
  async register(req, res, next) {
    ...
    try {
      ...
      if (validateEmail(email)) {
        ...
        return res.json({
          message: "🎉 Almost there! <br> Please follow the instructions in the email we sent to you to verify your account.",
        });
      }
    } catch (err) {
      return next(err);
